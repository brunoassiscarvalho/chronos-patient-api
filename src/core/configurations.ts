export default class Configurations {
    ...
    constructor() {
        ...
        this.TWILLIO = {
            ...
            serviceId: process.env.TWILIO_CONVERSATIONS_SERVICE_SID,
        }

        this.AWS = {
            id: process.env.AWS_SDK_ID,
            secret: process.env.AWS_SDK_SECRET,
            bucket: process.env.AWS_BUCKET_NAME,
        }

        this.VIDEO = {
            antecipationTime:
                Number(process.env.VIDEO_ANTICIPATION_TIME_MIN) || 0,
            lateTime: Number(process.env.VIDEO_LATE_TIME_MIN) || 0,
        }
    }
}
